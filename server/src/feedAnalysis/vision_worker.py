...
VISION_ROOT = Path(__file__).resolve().parents[3] / "vision"
    ...
    return analyze_recording(
        {
            ...
            "durationSec": payload.get("durationSec") or 0,
            ...
            "cutePolicy": payload.get("cutePolicy"),
            "sampleSeconds": payload.get("sampleSeconds"),
            "sampleOffsetSeconds": payload.get("sampleOffsetSeconds"),
            "screenOnly": bool(payload.get("screenOnly")),
            "adaptiveFeeding": bool(payload.get("adaptiveFeeding")),
            "fixedBottomBowlRegion": bool(payload.get("fixedBottomBowlRegion")),
